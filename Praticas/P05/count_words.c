...
{
  // 1. pesquisa word
  //   se encontrou incremeta o value
  //   se nao insere no
  //       usar a função allocate_hash_table_node
  //       copiar a palavra par ao campo key do novo no
  //       colocar o campo value com valor 1
  //     usar a função insert_hash_table_node 
...
int main(int argc,char **argv)
{
  ...
  for(i = 1;i < argc;i++)
  {
    ...
    //
            // chamar função init_hash_table e indicar o tamanho da tabela
    //
